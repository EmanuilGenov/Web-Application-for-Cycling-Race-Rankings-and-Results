...
{
	private readonly CyclingRaceRankingsDbContext _context;

	public SeedDataService(CyclingRaceRankingsDbContext context)
	{
		_context = context;
	}
	...
	public async Task SeedDataAsync()
	{
		...
		{
			new Cyclist { Id = Guid.NewGuid().ToString(), Name = "Arlen Tavis", Email = "arlen@cycling.com", PasswordHash = "HASHED_PASSWORD", DateOfBirth = new DateTime(1995, 6, 15), Nationality = "Velandian", TeamId = teams[0].Id },
			new Cyclist { Id = Guid.NewGuid().ToString(), Name = "Bren Loric", Email = "bren@cycling.com", PasswordHash = "HASHED_PASSWORD", DateOfBirth = new DateTime(1998, 9, 3), Nationality = "Crestorian", TeamId = teams[1].Id },
			new Cyclist { Id = Guid.NewGuid().ToString(), Name = "Calla Vey", Email = "calla@cycling.com", PasswordHash = "HASHED_PASSWORD", DateOfBirth = new DateTime(2001, 4, 22), Nationality = "Zephyrian", TeamId = teams[2].Id }
		};
